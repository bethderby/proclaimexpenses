         ...
         <tbody className="divide-y divide-slate-100">
           {teams.map(t=>{
             ...
             return <tr key={t.id} className="transition hover:bg-slate-50">
               ...
               <td className="px-5 py-5 align-top"><p className="text-sm font-semibold text-slate-900">{money(t.budgetTarget)}</p><div className="mt-2 h-1.5 w-36 overflow-hidden rounded-full bg-slate-100"><div className="h-full rounded-full bg-[#146650]" style={{width:`${pct}%`}} /></div></td>
