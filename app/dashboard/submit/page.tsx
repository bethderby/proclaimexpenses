...
export default async function SubmitPage() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold text-stone-900 tracking-tight mb-1">Submit a request</h2>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                name="amount"
                required
                className="h-10 w-full rounded-xl border border-stone-300 pl-7 pr-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-600"
