...
export default async function ExpensesPage({searchParams}:{searchParams:{from?:string;to?:string}}){
 ...
 return <div className="space-y-6">
  <div><p className="text-sm font-semibold text-[#C99600]">Expenses</p><h1 className="mt-1 text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl">Submit and manage expenses.</h1><p className="mt-2 max-w-3xl text-sm text-slate-500"></p></div>
