...
export default async function ReportsPage(){
 ...
 const spendByTeam:Record<string,number>={}; teams.forEach(t=>spendByTeam[t.id]=0); expenses.forEach(e=>spendByTeam[e.teamId]=(spendByTeam[e.teamId]||0)+Number(e.amount));
 ...
 const monthTotals:Record<string,number>={}; expenses.forEach(e=>{const mk=e.date.toISOString().slice(0,7);monthTotals[mk]=(monthTotals[mk]||0)+Number(e.amount);});
