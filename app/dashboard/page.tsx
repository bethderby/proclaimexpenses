 ...
 return <div className="page-stack dashboard-page">
  ...
  <section className="panel dashboard-panel overflow-hidden">
    ...
    <div className="divide-y divide-slate-100">
      {expenses.length===0?<div className="empty-state m-4">No expenses yet.</div>:expenses.map(e=><Link key={e.id} href={`/dashboard/expense-history#expense-${encodeURIComponent(e.id)}`} className="expense-summary-row">
