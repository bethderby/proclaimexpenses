...
export default async function DashboardPage(){
 ...
 return <div className="space-y-6 sm:space-y-8"><div><p className="text-sm font-semibold text-[#C99600]">Overview</p><h1 className="mt-1 text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl">Good to see you, {user.name?.split(' ')[0]||'there'}.</h1><p className="mt-2 max-w-2xl text-sm text-slate-500">Keep expenses, approvals, receipts and Co-op payment runs in one place.</p></div>
