...
export async function GET(req:NextRequest){
 ...
 await recordAuditEvent({ action: 'RECEIPT_REMINDERS_RUN', entityType: 'CRON', entityId: 'receipt-reminders', summary: `Receipt reminder job checked ${expenses.length} expenses and sent ${sent} reminders`, metadata: { checked: expenses.length, sent } });
